							...
							<div className="grid grid-cols-2 gap-4 text-sm">
								<div className="space-y-1">
									...
									<div className="font-medium">
										{selectedBooking?.bookingId?.slice(
											0,
											27
										) + "..." || ""}
									</div>
								...
								<div className="space-y-1">
									...
									<MuiButton
										...
										onClick={() =>
											window.open(
												`https://www.google.com/maps?q=${selectedBooking?.shopDetails?.location?.coordinates?.[1]},${selectedBooking?.shopDetails?.location?.coordinates?.[0]}`,
												"_blank"
											)
										}
