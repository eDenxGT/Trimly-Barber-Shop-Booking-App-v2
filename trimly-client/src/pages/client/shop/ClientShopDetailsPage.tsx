	...
	const reviews = [
		{
			...
			rating: 5,
			reviewText:
				"Great haircut! The barber was professional and understood exactly what I wanted.",
		...
		},
		{
			...
			rating: 4,
			reviewText:
				"Excellent service and atmosphere. Would definitely recommend to friends!",
			...
			<main className="flex-1">
				...
				<div className="relative">
					...
					{role === "client" && (
						<Button
							onClick={() =>
								handleRedirectBooking(shop.userId || "")
							}
					...
					<div className="flex items-start">
						...
						<div className="flex-1">
							...
							<div className="flex items-center gap-1 mt-1">
								...
								<span className="text-gray-700">5.0 (24)</span>
							</div>
						</div>
					</div>
								...
								<div className="space-y-4">
									...
									<div>
										...
										<div className="flex flex-wrap gap-2">
											{shop.amenities &&
											Object.keys(shop.amenities).length >
												0 ? (
												Object.entries(
													shop.amenities
												).map(
										...
										<div className="h-40 rounded-lg overflow-hidden">
											{shop.location?.coordinates ? (
												<iframe
													...
													allowFullScreen
													loading="lazy"
													src={`https://www.google.com/maps?q=${shop.location.coordinates[1]},${shop.location.coordinates[0]}&output=embed`}></iframe>
											) : (
